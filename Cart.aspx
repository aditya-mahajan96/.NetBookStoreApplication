<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Mahajan_BookStore_921.Cart" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cart Page- Aditya Mahajan</title>
            ...
            <div class="row"><%-- row 2 --%>
                <div class="col-sm-12">
                    ...
                    <div class="form-group"><%-- buttons --%>
                        <div class="col-sm-12">
                            <asp:Button ID="btnContinue" runat="server" Text="Continue Shopping" CssClass="btn"   PostBackUrl="~/Products_921.aspx"  />
                            <asp:Button ID="btnCheckOut" runat="server" Text="Check Out" CssClass="btn"  PostBackUrl="~/Checkout_8921.aspx" />
                        </div>
                    </div>
                </div>
            </div><%-- end of row 2 --%>
